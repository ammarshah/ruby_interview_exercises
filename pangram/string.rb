...
class String
    ...
    def missing_pangram_letters
        ENGLISH_ALPHABETS - self.downcase.chars
    end
...
p str.is_pangram? # => false
p str.missing_pangram_letters # => ["r", "s", "t", "u", "v", "w"]

sentence = "The quick brown fox jumps over the lazy dog!"
p sentence.is_pangram? # => true
p sentence.missing_pangram_letters # => []
