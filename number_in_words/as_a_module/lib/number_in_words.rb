module NumberInWords
    ...
    def NumberInWords.in_words(number, titleize: false, add_and: false)
        begin
            raise ArgumentError.new("Number should only be of an Integer or a String type") unless number.is_a?(Integer) or number.is_a?(String)
    ...
    def NumberInWords.convert_string_into_chunks_of_max_three_digits(str)
        begin
            raise ArgumentError.new("Please provide a number as a String type") unless str.is_a?(String)
    ...
    def NumberInWords.convert_all_chunks_into_words(chunks_array)
        begin
            raise ArgumentError.new("Please provide an array of chunks of string type") unless chunks_array.is_a?(Array)
    ...
    def NumberInWords.chunk_resolver(chunk:, first_digit_unit_place_value:)
        begin
            raise ArgumentError.new("Please provide a chunk of string type and first_digit_unit_place_value of integer type") unless chunk.is_a?(String) and first_digit_unit_place_value.is_a?(Integer)
    ...
    def NumberInWords.unit_resolver(digit_str:, **options)
        begin
            raise ArgumentError.new("Please provide a single digit number of string type") unless digit_str.is_a?(String)
    ...
    def NumberInWords.ten_resolver(number_str:, **options)
        begin
            raise ArgumentError.new("Please provide a two digits number of string type") unless number_str.is_a?(String)
    ...
    def NumberInWords.hundred_resolver(number_str:, units_array:)
        begin
            raise ArgumentError.new("Please provide a number of string type and an array of units") unless number_str.is_a?(String) and units_array.is_a?(Array)
            words = [
